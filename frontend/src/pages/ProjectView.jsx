        ...
        <div className="w-[100%] px-5 md:w-[1000px]">
          <div className="space-y-12">
            <div className="border-b border-gray-900/10 pb-12">
              ...
              <div className="w-full sm:col-span-4">
                <p className="text-2xl mt-2 mb-2">Technologies</p>
                <ul className="list-disc">
              ...
              <div className="w-full sm:col-span-4">
                <p className="text-2xl mt-2 mb-2">Stack:</p>
                <p>{stack}</p>
              </div>
              <div className="w-full sm:col-span-4">
                <p className="text-2xl mt-2 mb-2">Deployed:</p>
                <p>{deployed}</p>
              </div>
              <div className="w-full sm:col-span-4">
                <p className="text-2xl mt-2 mb-2">Github Repository Link:</p>
                <Link to={gitRepoLink} target="_blank" className="text-sky-700">
                  {gitRepoLink}
                </Link>
              </div>
              <div className="w-full sm:col-span-4">
                <p className="text-2xl mt-2 mb-2">Project Link:</p>
                <Link
